#
#  Retrains the best model from Kristjan Poska's experiments
#  (https://github.com/pxska/bakalaureus/tree/main/experiments)
#  on the new data split. 
#  Saves the model into  retrain_estnltk_ner / best_model
#
...
start = datetime.now()
new_model_dir = os.path.join('retrain_estnltk_ner', 'best_model')
