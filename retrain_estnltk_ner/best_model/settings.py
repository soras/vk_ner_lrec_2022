...
#GAZETTEER_FILE = os.path.join('..', 'experiments', 'models', 'gazetteer_both_lowercase_added_loc_and_variants.txt')
GAZETTEER_FILE = os.path.join('retrain_estnltk_ner', 'gazetteer_both_lowercase_added_loc_and_variants.txt')
...
FEATURE_EXTRACTORS = (
    "retrain_estnltk_ner.protocols_fex.NerEmptyFeatureTagger",
    "retrain_estnltk_ner.protocols_fex.NerLocalFeatureWithoutMorphTagger",
    "retrain_estnltk_ner.protocols_fex.NerBasicMorphFeatureTagger",
    "estnltk.taggers.estner.fex.NerSentenceFeatureTagger",
    "retrain_estnltk_ner.protocols_fex.NerGazetteerFeatureTagger",
