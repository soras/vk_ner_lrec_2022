#
#  Evaluates retrained best model from Kristjan Poska's 
#  experiments on the new data split (on dev and test sets). 
#
...
start = datetime.now()
model_dir = os.path.join('retrain_estnltk_ner', 'best_model')
...
write_out_results( dev_results, 'estnltk-best-ner', 'dev', results_dir )
# test set
...
log.info( pretty_results )
write_out_results( test_results, 'estnltk-best-ner', 'test', results_dir )
